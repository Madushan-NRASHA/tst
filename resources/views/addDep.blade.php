...
">
        ...
        <script>
            function confirmDelete(event, url) {
                ...
                if (confirm('Are you sure you want to delete this category? if You Delete ThiS Company All Users Also Removing AutoMaicly And This action cannot be undone.')) {
